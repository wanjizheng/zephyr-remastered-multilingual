...
[下载 v0.5.3](https://github.com/wanjizheng/zephyr-remastered-multilingual/releases/tag/v0.5.3) · [完整中英双语说明 / Full release notes](changelogs/v0.5.3.md)

## [0.4.7] - 2026-09-24（本地构建，未发布）

- 接入 060、083、109 的简繁视频和 083、109 英文视频；060 英文保留原片。
- 按所选语言重建 movie bundle，更新 VideoClip 数据位置、长度及 catalog CRC / 大小 / hash，并纳入现有备份和事务流程。
- 构建前核对视频输入；本地视频不提交 Git。维护方式与分发边界见 [视频语言包](docs/video-localization.md)。
- 离线资源重建与校验记录随本地交付提供，游戏内播放尚待确认。
...
- 感谢 [@ElysiumWorks](https://github.com/ElysiumWorks) 在 [Issue #1](https://github.com/wanjizheng/zephyr-remastered-multilingual/issues/1) 指出技能名前缀人物姓名的问题。本版已修正这项反馈；该 issue 中的其他译名建议仍单独评估。
...
- Thanks to [@ElysiumWorks](https://github.com/ElysiumWorks) for reporting character-name prefixes on skills in [Issue #1](https://github.com/wanjizheng/zephyr-remastered-multilingual/issues/1). This release fixes that issue; the separate character-name suggestion in the same report remains under review.
...
- 发行包只保留运行文件与许可证；详细历史见 [v0.2.0 发布说明](https://github.com/wanjizheng/zephyr-remastered-multilingual/releases/tag/v0.2.0)。
...
- Reduced the release ZIP to runtime files and license notices; see the [v0.2.0 release notes](https://github.com/wanjizheng/zephyr-remastered-multilingual/releases/tag/v0.2.0) for details.
...
[0.4.1]: https://github.com/wanjizheng/zephyr-remastered-multilingual/releases/tag/v0.4.1
[0.4.0]: https://github.com/wanjizheng/zephyr-remastered-multilingual/releases/tag/v0.4.0
[0.2.0]: https://github.com/wanjizheng/zephyr-remastered-multilingual/releases/tag/v0.2.0
[0.1.0]: https://github.com/wanjizheng/zephyr-remastered-multilingual/releases/tag/v0.1.0
