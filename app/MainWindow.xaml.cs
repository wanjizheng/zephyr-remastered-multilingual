...
public partial class MainWindow : Window
{
 ...
 async void AppLanguageChanged(object sender,RoutedEventArgs e)
 {
  ...
  VersionBadge.Text=english?"v0.4.10":hant?"v0.4.10":"v0.4.10";
  ...
  FooterVersion.Text=english?"v0.4.10 · Unofficial localization tool":hant?"v0.4.10 · 非官方漢化工具":"v0.4.10 · 非官方汉化工具";
