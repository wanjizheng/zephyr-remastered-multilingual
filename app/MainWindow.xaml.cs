...
public partial class MainWindow : Window
{
 ...
 async void AppLanguageChanged(object sender,RoutedEventArgs e)
 {
  ...
  VersionBadge.Text=english?"v0.4.0 release":hant?"v0.4.0 正式版":"v0.4.0 正式版";
  ...
  FooterVersion.Text=english?"v0.4.0 · Unofficial localization tool":hant?"v0.4.0 · 非官方漢化工具":"v0.4.0 · 非官方汉化工具";
